...
import Vitals from '../../../js/features/vitals/vitals';
...
describe('Vitals', () => {
  ...
  beforeEach(() => {
    ...
    vitals = component.find('Vitals').at(0);
    ...
    vitalsNoData = componentNoData.find('Vitals').at(0);
  });
  ...
  it('renders without crashing no Data', () => {
    expect(vitalsNoData).toBeDefined();
    componentNoData.unmount();
  });
  it('clicking buttons work', () => {
    expect(vitals.state()).toEqual(initialState);
    const button = vitals.find('VcButton').at(0);
    button.simulate('click');
    expect(vitals.state()).toEqual(secondState);
