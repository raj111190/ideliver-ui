...
import VcReferPatientContainer from '../../../js/features/VcReferPatient/vcReferPatientContainer';
import VcReferPatient from '../../../js/features/VcReferPatient/vcReferPatient';

describe('VcReferPatientContainer', () => {
  ...
  it('should render without throwing an error', () => {
    ...
    const container = component.find(VcReferPatient).at(0);
    ...
    const patientNotes = componentWithoutEncounter.find(VcReferPatient).at(0);
    ...
    const newEncAction = [
      ...
      {
        encounter: {
          encounterType: '1090407f-fc73-46c9-9311-2bd16b0d6742',
          obs: [
            {
              concept: '36cfb426-a0a3-426d-a3d7-474cdd560ec7',
              encounter: { uuid: 'encounter123' },
